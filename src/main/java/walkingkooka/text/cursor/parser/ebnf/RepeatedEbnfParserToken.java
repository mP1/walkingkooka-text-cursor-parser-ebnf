...
public final class RepeatedEbnfParserToken extends ParentEbnfParserToken<RepeatedEbnfParserToken> {
    ...
    private RepeatedEbnfParserToken(final List<ParserToken> tokens, final String text) {
        super(tokens, text);
    ...
    @Override
    public RepeatedEbnfParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                RepeatedEbnfParserToken::new
        );
    }

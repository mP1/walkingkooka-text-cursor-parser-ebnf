...
final public class AlternativeEbnfParserToken extends ParentEbnfParserToken {
    ...
    private AlternativeEbnfParserToken(final List<ParserToken> tokens, final String text) {
        super(tokens, text);
    ...
    @Override
    public AlternativeEbnfParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                AlternativeEbnfParserToken::new
        );
    }

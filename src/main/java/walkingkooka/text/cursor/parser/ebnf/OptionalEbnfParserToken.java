...
public final class OptionalEbnfParserToken extends ParentEbnfParserToken {
    ...
    private OptionalEbnfParserToken(final List<ParserToken> tokens, final String text) {
        super(tokens, text);
    ...
    @Override
    public OptionalEbnfParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                OptionalEbnfParserToken::new
        );
    }

...
public final class EbnfRuleParserToken extends EbnfParentParserToken<EbnfRuleParserToken> {
    ...
    @Override
    public EbnfRuleParserToken removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public EbnfRuleParserToken removeIf(final Predicate<ParserToken> predicate) {

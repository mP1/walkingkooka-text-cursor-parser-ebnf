...
public final class EbnfRepeatedParserToken extends EbnfParentParserToken<EbnfRepeatedParserToken> {
    ...
    @Override
    public Optional<EbnfRepeatedParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public EbnfRepeatedParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public EbnfRepeatedParserToken replaceIf(final Predicate<ParserToken> predicate,

...
final class RangeEbnfParserTokenConsumer implements Consumer<EbnfParserToken> {

    static RangeEbnfParserTokenConsumer with() {
        return new RangeEbnfParserTokenConsumer();
    }

    private RangeEbnfParserTokenConsumer() {
        super();
    }

...
public final class ExceptionEbnfParserToken extends ParentEbnfParserToken<ExceptionEbnfParserToken> {
    ...
    private ExceptionEbnfParserToken(final List<ParserToken> tokens, final String text) {
        super(tokens, text);
    ...
    @Override
    public ExceptionEbnfParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                ExceptionEbnfParserToken::new
        );
    }

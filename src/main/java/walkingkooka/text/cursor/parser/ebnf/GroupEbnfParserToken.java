...
public final class GroupEbnfParserToken extends ParentEbnfParserToken<GroupEbnfParserToken> {
    ...
    private GroupEbnfParserToken(final List<ParserToken> tokens, final String text) {
        super(tokens, text);
    ...
    @Override
    public GroupEbnfParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                GroupEbnfParserToken::new
        );
    }

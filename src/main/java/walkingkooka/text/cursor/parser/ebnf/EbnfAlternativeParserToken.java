...
final public class EbnfAlternativeParserToken extends EbnfParentParserToken<EbnfAlternativeParserToken> {
    ...
    @Override
    public Optional<EbnfAlternativeParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<EbnfAlternativeParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public EbnfAlternativeParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public EbnfAlternativeParserToken replaceIf(final Predicate<ParserToken> predicate,

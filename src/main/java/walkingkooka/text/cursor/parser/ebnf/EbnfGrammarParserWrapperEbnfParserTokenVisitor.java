...
final class EbnfGrammarParserWrapperEbnfParserTokenVisitor extends EbnfParserTokenVisitor {

    static ParserToken wrap(final ParserToken token,
                            final BiFunction<List<ParserToken>, String, ParserToken> wrapper) {
        final EbnfGrammarParserWrapperEbnfParserTokenVisitor visitor = new EbnfGrammarParserWrapperEbnfParserTokenVisitor();
        visitor.accept(token);
        return wrapper.apply(visitor.tokens, token.text());
    }

    EbnfGrammarParserWrapperEbnfParserTokenVisitor() {
        super();
    }

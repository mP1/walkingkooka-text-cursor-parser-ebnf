...
public class GroupEbnfParserTokenTest extends GroupOptionalRepeatParentEbnfParserTokenTestCase<GroupEbnfParserToken> {
    ...
    public void testAccept() {
        ...
        final GroupEbnfParserToken group = this.createToken();
        ...
        new FakeEbnfParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final GroupEbnfParserToken t) {
                assertSame(group, t);
                b.append("5");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final GroupEbnfParserToken t) {
                assertSame(group, t);
                b.append("6");
                visited.add(t);
            }
    ...
    @Override
    GroupEbnfParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<GroupEbnfParserToken> type() {
        return GroupEbnfParserToken.class;
    }
}

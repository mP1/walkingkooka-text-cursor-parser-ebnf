...
public final class TerminalEbnfParserTest extends EbnfParserTestCase3<TerminalEbnfParserToken> {
    ...
    public void testParseInvalidBackslash() {
        assertThrows(
                TerminalEbnfParserException.class,
    ...
    private void parseAndCheck2(final String quoted,
        ...
        this.parseAndCheck(
                quoted + after,
                TerminalEbnfParserToken.with(text, quoted),
                quoted,
                after
        );
    }
    ...
    @Override
    TerminalEbnfParserToken token(final String text) {
        final String quotedText = this.text();
        return TerminalEbnfParserToken.with(
